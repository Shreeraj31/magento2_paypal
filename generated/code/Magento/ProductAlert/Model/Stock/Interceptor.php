<?php
namespace Magento\ProductAlert\Model\Stock;

/**
 * Interceptor class for @see \Magento\ProductAlert\Model\Stock
 */
class Interceptor extends \Magento\ProductAlert\Model\Stock implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerCollection');
        if (!$pluginInfo) {
            return parent::getCustomerCollection();
        } else {
            return $this->___callPlugins('getCustomerCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByParam');
        if (!$pluginInfo) {
            return parent::loadByParam();
        } else {
            return $this->___callPlugins('loadByParam', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deleteCustomer');
        if (!$pluginInfo) {
            return parent::deleteCustomer($customerId, $websiteId);
        } else {
            return $this->___callPlugins('deleteCustomer', func_get_args(), $pluginInfo);
        }
    }
